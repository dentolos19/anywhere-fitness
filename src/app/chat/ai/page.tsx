...
export default function Page() {
  ...
  const [messages, setMessages] = useState([
    {
      name: "Baymax",
      message: "Hello! I am Baymax, your personal fitness and healthcare companion.",
      yourself: false,
    },
  ]);
  ...
  return (
    <PageContainer requireLogin={true}>
      ...
      <Box sx={{ width: "100vw", position: "fixed", bottom: { xs: 80, sm: 30 }, left: 0 }}>
        <Container>
          <Paper component={"form"} onSubmit={sendHandler} sx={{ display: "flex", marginLeft: "auto", marginRight: "auto", padding: 1, gap: 1 }}>
